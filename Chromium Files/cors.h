...
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPSourceOrigin[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPSourceIP[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPRequestMethod[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPRequestHeaders[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPAllowOrigin[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPAllowIP[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPAllowMethods[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPAllowHeaders[];
COMPONENT_EXPORT(NETWORK_CPP)
extern const char kINPMaxAge[];
