...
// INP headers
const char kINPSourceOrigin[] = "X-INP-Source-Origin";
const char kINPSourceIP[] = "X-INP-Source-IP";
const char kINPRequestMethod[] = "X-INP-Request-Method";
const char kINPRequestHeaders[] = "X-INP-Request-Headers";
const char kINPAllowOrigin[] = "X-INP-Allow-Origin";
const char kINPAllowIP[] = "X-INP-Allow-IP";
const char kINPAllowMethods[] = "X-INP-Allow-Methods";
const char kINPAllowHeaders[] = "X-INP-Allow-Headers";
const char kINPMaxAge[] = "X-INP-Max-Age";
